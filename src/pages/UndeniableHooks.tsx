...
const GROUPS: Array<{ label: string; items: Array<string | { q: string; star?: boolean }> }> = [
  ...
  { label: 'Core beliefs · hot take fuel', items: [
    S('You don\'t have an awareness problem. You have a trust problem.'),
    '80% of your market already knows you. They\'re sitting on the fence, not in the dark.',
    'Coaching is a career, not a hobby. Treat it like a hobby and you\'ll get paid like one.',
    'You don\'t choose your niche. Your content already chose it for you.',
    'You don\'t get to choose who you coach on day one. The dollars do.',
    S('Pay in full looks great in a screenshot and it quietly burns the client.'),
    'Selling in the DMs only converts people who already trust you. It never cracks a cold audience.',
    'Weight loss is a hyper emotional decision. Stop selling it like a spreadsheet.',
    S('People buy people, not product. Hide your face and you stay small.'),
    'A 20 minute check in doesn\'t make you a better coach. More is not more valuable.',
    'You don\'t find your best client. You build them.',
    'Status is why people actually buy. Nobody wants to admit it.',
    S('Right problem, wrong way is the most expensive place in business. You won\'t feel it for five years.'),
    'Vertical growth feels amazing until it stops. That\'s why coaches at 40K months get depressed.',
  ]},
