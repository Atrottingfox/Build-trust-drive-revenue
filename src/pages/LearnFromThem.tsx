...
const LESSONS: Lesson[] = [
  ...
  },
  {
    ...
    applied: ['Jay Wright', 'Rhys Livingstone', 'Sam Ackland', 'Hey Doza'],
    detail: [
  ...
  },
  {
    ...
    detail: [
      'Media structure rebuilt, roles and compensation defined, interview and trial process installed, Creative Director recruited, and team trained.',
    ],
  },
  {
    n: '04',
