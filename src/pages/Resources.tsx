...
const resources: Resource[] = [
  ...
  {
    id: 'belief-builder',
    title: 'The Belief Architecture Builder',
    subtitle: '5 steps to your positioning foundation.',
    description: 'Extract the 5 beliefs that separate you from everyone in your space. Build contrarian stacks backed by evidence. Walk away with a positioning statement and content pillars.',
    problem: 'I sound like everyone else. I do not know what makes me different.',
    type: 'build',
    typeLabel: 'Framework',
