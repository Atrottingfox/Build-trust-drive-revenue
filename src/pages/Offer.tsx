        ...
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          <Section>
            ...
            <p className="text-zinc-400 leading-relaxed">
              For 7-8 figure B2B founders, coaches and consultants doing $200K/month+.
            </p>
            ...
            <p className="text-zinc-400 leading-relaxed">
              I've spent the last 24 months behind the scenes with 7 & 8 figure B2B founders, coaches and consultants doing $200K/month+, turning content into an engine that consistently drives revenue. As of writing, our average client is doing $1.06M per month.
            </p>
