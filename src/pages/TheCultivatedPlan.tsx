...
const AVATAR = [
  {
    ...
    said: [
      "Having the conversation and it going sideways.",
      "Turning over three managers in two years.",
      "Not attracting top talent because no one knows who they are.",
      "The underperformer they've known about for months.",
      "Revenue keeps climbing and the team can't carry it, so something breaks in front of a client.",
      "Doing this exact job in five years, because nobody else can do it properly.",
    ],
    unsaid: [
      "That they're the bottleneck and they already know it.",
      "That they wanted to be a leader and have never actually been one.",
      "I've built something that can't run without me, which means I haven't built a business.",
      "I was never any good with people, and it's the only thing left I have to be good at.",
      "If I properly let go, I'll find out I wasn't needed.",
      "Everyone can see it's me, and nobody's going to say it to my face.",
    ],
  },
  {
    row: "Frustrations",
    ...
    said: [
      "Time poor, doing everything themselves.",
      "Constantly in the wings having to do the things himself.",
      "No consistency, people aren't being held to the same standard.",
      "Hired people to create capacity and everything still comes back to them.",
      "Solving problems three layers below their pay grade.",
      "I've explained it. They're still not doing it.",
      "Nothing lands when it's meant to and I never know in advance whether it will.",
    ],
    unsaid: [
      "They don't know what they're doing. They can't do it. I've hired an idiot. They just don't get it.",
      "I'm the only one here who actually cares about this.",
      "It's quicker if I just do it, and I know that's the whole problem.",
      "I'm paying for capability I'm not getting.",
      "I've said the same thing to the same person four times now.",
    ],
  },
  {
    row: "Wants",
    ...
    said: [
      ...
      "People delivering on what they said they'd deliver.",
      "My time back.",
      "To spend the week on the work I'm actually good at.",
      "One place I can look to know whether we're on track.",
      "To stop being the escalation point for everything.",
    ],
    unsaid: [
      "To look competent and successful.",
      "To not be the one who gets told they suck as a leader.",
      ...
      "Someone to tell me what good actually looks like, because I've never seen it done properly.",
  ...
  },
  {
    ...
    said: [
      "A business people wanna be a part of.",
      "Attracting top talent, being known as a good place to work.",
      "Keeping the good ones because they're fucking good.",
      "Revenue growth that the team actually grows with.",
      "Growth that doesn't cost me my weekends.",
      "A leadership team that runs it, so I get to work on it instead of in it.",
    ],
    unsaid: [
      "To feel aspirational. To be the person someone else comes to for help.",
      ...
      "To have chosen this on purpose, rather than ending up here.",
    ],
  },
];
...
const AVATAR_PROFILE = [
  ...
  { k: 'Primary emotions', v: 'Frustration, avoidance, and anxiety they have built themselves by putting the conversation off. Stretched, doing two jobs and neither properly. Quietly resentful that nobody else seems to care as much. Embarrassed that the people part is the bit they cannot do.' },
