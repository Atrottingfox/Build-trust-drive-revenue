          ...
          <Section>
            <div className="max-w-3xl">
              ...
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-[-0.03em] text-white leading-[1.05] mb-6">
                In 30 days we'll build a content to client path that attracts qualified leads every week
                <br />
                <span className="text-zinc-500">without going viral.</span>
              </h1>
            ...
            <div className="max-w-3xl">
              <div className="space-y-5 text-zinc-400 text-lg leading-relaxed">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start gap-3">
                    <X className="w-4 h-4 text-zinc-600 mt-1.5 flex-shrink-0" />
                    <span>No posting 5x per day waiting for the next jackpot to flood the pipeline.</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <Section>
            <div className="max-w-3xl">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-extrabold tracking-[-0.02em] text-white leading-[1.1] mb-8">
                AU$5,000 + GST
                <br />
                <span className="text-zinc-500">for the next 5 to lock it in.</span>
              </h2>

              <div className="p-6 bg-surface border border-zinc-800/50 rounded-2xl mb-8">
                <p className="text-white font-semibold mb-4">ROI sanity check:</p>
                <div className="space-y-3 text-zinc-400 text-sm leading-relaxed">
                  <p>
                    Typically, the average client of those I work with is $15K+.
                    Therefore, this sprint pays for itself with:
                  </p>
                  <ul className="space-y-2 ml-1">
                    <li className="flex items-start gap-3">
                      <div className="w-1 h-1 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                      <span>1-2 extra high ticket clients over the next 90 days, or</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-1 h-1 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
                      <span>A consistent lift of a few content sourced calls per month at your normal close rate</span>
                    </li>
                  </ul>
                  <p>
