...
const SHORT_FORM_SHOOT: SFOutline[] = [
  ...
  },
  {
    ...
    spoken: ["If you want to run a million dollar studio you actually want to turn up to every day."],
    beats: [
      { role: 'Common belief', text: "We need to get to a place where members aren't paying for your presence, they're paying for your standards." },
