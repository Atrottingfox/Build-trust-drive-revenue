...
-- Create RLS policies for belief_map_entries (with existence checks)
DO $$
BEGIN
  IF NOT EXISTS (
...
-- Create RLS policies for belief_map_concepts (with existence checks)
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
...
-- Create RLS policies for belief_map_messages (with existence checks)
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
...
-- Create RLS policies for belief_map_content_ideas (with existence checks)
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
